  ...
  return (
    <div className="p-4 bg-gray-300 w-full lg:h-[500px] h-[400px]" id="contactus">
        <div className="flex bg-white flex-col justify-between h-full p-4 rounded-2xl">
            <h1 className="uppercasse self-end text-right md:text-lg text-sm uppercase font-bold md:w-[40%] w-[60%] z-10">
            ...
            <img src="footer-img.png" alt="footerimg" className="lg:w-[350px] w-[130px] h-auto absolute z-0" />
            ...
            <div className="flex lg:flex-row flex-col items-center justify-center lg:gap-10 gap-5 z-10 mt-10">
                ...
                <div className="flex lg:items-start items-center justify-start flex-col font-bold text-lg text-left">
                    <Link href="tel:+917352949328" className="flex items-center gap-1">
                        <FaPhone className="lg:text-xl text-sm"/>
                        +91 7352949328
                    </Link>
                    <Link href="mailto:synkdigital0@gmail.com?subject=Enquiry for a Project" className="flex items-center gap-1">
